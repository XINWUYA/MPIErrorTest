...
//**********************************************************************************
//FUNCTION:
bool MPICommon::createMPICommGroup(int * vpRanks, int vGroupSize, MPI_Comm& voComm/*, int vRootRankID*/)
{
	if (!vpRanks || vGroupSize <= 0)
	{
	...
	MPI_Group_incl(WorldGroup, vGroupSize, vpRanks, &PrimeGroup);
	MPI_Comm PrimeComm;
